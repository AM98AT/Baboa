...
def render_personal_reco(tests):
    ...
    if lows:
        st.markdown("**واطية حالياً:** " + "، ".join(t["full_name"] for t in lows))
    ...
    st.info(
        "عنده صوديوم واطي + كلى متعبة، فالماي الزايد يكدر يكون خطير. "
    ...
    st.info(
        ...
        "• قلّبوا وضعيته كل ساعة–ساعتين لحماية الجلد من القُرَح (أهم لأن بروتين دمه واطي).\n\n"
